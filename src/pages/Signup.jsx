    ...
    <div style={{
      ...
      <div className="fade-up" style={{ width: '100%', maxWidth: '440px', position: 'relative', zIndex: 2 }}>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ marginTop: '10px' }}>
                <div style={{ display: 'flex', gap: '4px', marginBottom: '6px' }}>
                  {[1, 2, 3, 4].map(i => (
                    <div
                      key={i}
                      className={`strength-bar ${i <= passwordStrength ? `active-${passwordStrength}` : ''}`}
                    />
                  ))}
                </div>
                <p style={{
                  fontSize: '11px',
                  color: passwordStrength >= 3 ? '#6B9E7F' : passwordStrength === 2 ? '#A89968' : '#A89968',
          ...
          <p style={{ fontSize: '12px', color: '#A89968', textAlign: 'center', lineHeight: 1.5, marginTop: '8px' }}>
