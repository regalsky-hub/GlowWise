      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <section className="fade-up" style={{ marginBottom: '48px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '20px', gap: '12px', flexWrap: 'wrap' }}>
            <div>
              <div className="eyebrow" style={{ marginBottom: '8px' }}>Your support plan</div>
              <h2 className="display" style={{ fontSize: '26px', color: '#3D4A52', fontWeight: 500 }}>
                Your wellness plan
              </h2>
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
            {[
              ...
              >
                ...
                />
                <div style={{ position: 'relative', zIndex: 2 }}>
                  <div className="eyebrow" style={{ marginBottom: '14px', color: item.accent, fontSize: '10px' }}>
                    {item.eyebrow}
                  </div>
                  <h3 className="display" style={{ fontSize: '22px', color: '#3D4A52', lineHeight: 1.3, marginBottom: '18px' }}>
                    {item.title}
                  </h3>
                  <div style={{ fontSize: '13px', color: item.accent, fontWeight: 600 }}>
                    {item.note}
                  </div>
                </div>
              </div>
