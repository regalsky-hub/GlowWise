...
#FAF8F5', border: '1px solid rgba(168, 153, 104, 0.15)', borderRadius: '12px', padding: '24px' }}>
      <h3 className="display" style={{ fontSize: '18px', color: '
#3D4A52', fontWeight: 500, marginBottom: '16px' }}>{title}</h3>
      <ResponsiveContainer width="100%" height={220}>
        <LineChart data={chartData}>
          <CartesianGrid strokeDasharray="3 3" stroke="rgba(168, 153, 104, 0.15)" />
          <XAxis dataKey="date" stroke="
#A89968" style={{ fontSize: '11px', fontFamily: 'Manrope' }} />
          <YAxis stroke="
#A89968" style={{ fontSize: '11px', fontFamily: 'Manrope' }} domain={domain} />
          <Tooltip contentStyle={{ backgroundColor: '
#FAF8F5', border: '1px solid rgba(168, 153, 104, 0.3)', borderRadius: '8px', fontFamily: 'Manrope' }} />
...
#3D4A52',
    ...
    >
      Understanding your{' '}
      <em style={{ fontStyle: 'italic', color: '
#6B9E7F' }}>
        wellness rhythms
      </em>
      {' '}over time.
      ...
      what may support your energy, mood, stress, and recovery most gently.
        ...
        {Object.keys(trends).length > 0 && (
          <section className="fade-up" style={{ marginBottom: '40px' }}>
            <h2 className="display" style={{ fontSize: '22px', color: '
#3D4A52', fontWeight: 500, marginBottom: '16px' }}>Weekly trends</h2>
        ...
        {chartData.length > 0 && (
          <section className="fade-up" style={{ marginBottom: '40px' }}>
            <h2 className="display" style={{ fontSize: '22px', color: '
#3D4A52', fontWeight: 500, marginBottom: '16px' }}>Wellness signals over time</h2>
            <div style={{
  background: '
#FAF8F5',
